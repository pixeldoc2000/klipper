...
where Klipper supports using the same pin multiple times. Otherwise,
the software does not expect a pin to be used multiple times, and
using this override is likely to cause confusing and unexpected
results.
